...
- [Previous meeting's notes](https://github.com/UPPMAX/linux-command-line-102/blob/main/docs/meeting_notes/20250403.md)
...
The workshop is intended for users with some Linux experience, see [the prerequisites](https://uppmax.github.io/linux-command-line-102/prerequisites/).
