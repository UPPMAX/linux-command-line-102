...
Repository: <https://github.com/UPPMAX/linux-command-line-102>
Rendered material: <https://uppmax.github.io/linux-command-line-102/>
...
- Where do we meet online?
    ...
    - Someplace else:
- [Decide on course name, UNDECIDED](https://github.com/UPPMAX/linux-command-line-102/issues/9)
...
- [Decide on MkDocs theme](https://github.com/UPPMAX/linux-command-line-102/issues/10)
    - [DECIDED] ReadTheDocs: RB, BB, BC
    - Materials: RB
    - Materials with ReadTheDocs layout: BB
- [Decide on using underscores or dashes in filename](https://github.com/UPPMAX/linux-command-line-102/issues/12)
...
| Linux pipe                 | [Learners can chain commands using the Linux pipe (6. Pipelines, p63-p64)](https://github.com/UPPMAX/linux-command-line-102/issues/6)                                   | RB, BB                     |
| Finding information        | [Learners have practiced using a book on bash/Linux](https://github.com/UPPMAX/linux-command-line-102/issues/7)                                                         | .                          |
...
The workshop is intended for users with some Linux experience, see [the prerequisites](https://uppmax.github.io/linux-command-line-102/prerequisites/). You do not need to be a member of a NAISS project in order to join the workshop, as we will provide one for you.
